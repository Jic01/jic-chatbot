...
function addChat(input, product) {
  ...
  botDiv.id = "bot";
  botDiv.innerHTML = `Jic: <span id="bot-response">${product}</span>`;
  chatDiv.appendChild(botDiv);
}
const userWord = [
  ["good day", "hi", "hey", "hello", "good morning", "good afternoon", "sup"],
  ["what can you do"],
...
const reply = [
  ...
  [
    "I'm JIC",
    "I am just a bot",
    "I am a bot. Who are you?",
    "I'm an assistant, not an actual person",
  ],
  ...
  [
    "What about?",
    "Once upon a time...",
    "I got my best friend a fridge for her birthday. i can't wait to see are face light up when she opens it",
  ],
  [
    "OK. Let me know if there's anything i can help you with",
    "Tell me a story",
    "Tell me a joke",
